...
<body>
            ...
            <div class="form">
                <form action="" method="post">
                    ...
                    <div class="input">
                        ...
                        <input class="form-control" id="id_login_email" type="text" name="">
                    </div>
                    
                    <div class="input">
                        <label for="id_login_pass">Contraseña</label>
                        <input class="form-control" id="id_login_pass" type="text" name="">
                    </div>
    ...
    <?php
    echo '<script src="../assets/js/login_register.js"></script>'
    ?>
</body>
